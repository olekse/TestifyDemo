...
public class OCRAsyncTask extends AsyncTask {
    ...
    public OCRAsyncTask(Activity activity, String apiKey, File file, String language, IOCRCallBack iOCRCallBack){
    ...
    protected String doInBackground(Object[] params) {
        ...
        try {
            ...
            return sendPost(isOverlayRequired, mFile, mLanguage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private String sendPost(boolean isOverlayRequired, File imageUrl, String language) throws Exception {
        ...
        try {
            MultipartUtility multipart = new MultipartUtility(url, "UTF-8", mApiKey);
